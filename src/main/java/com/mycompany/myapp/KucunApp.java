...
public class KucunApp {

    private static final Logger log = LoggerFactory.getLogger(KucunApp.class);

    private final Environment env;

    public KucunApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(KucunApp.class);
