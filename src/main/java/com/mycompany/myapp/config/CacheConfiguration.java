...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mycompany.myapp.domain.Alarm.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Uselog.class.getName(), jcacheConfiguration);
